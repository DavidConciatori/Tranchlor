...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Frame3.Controls.Add(Me.Text8)
        Me.Frame3.Controls.Add(Me.Text7)
        ...
        Me.Frame3.Location = New System.Drawing.Point(8, 88)
        Me.Frame3.Name = "Frame3"
        Me.Frame3.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.Frame3.Size = New System.Drawing.Size(465, 129)
        Me.Frame3.TabIndex = 20
        Me.Frame3.TabStop = False
        Me.Frame3.Text = "Maillage :"
        '
        'Combo1
        '
        ...
        Me.Combo1.Items.AddRange(New Object() {"1: écart constant", "2: écart proportionnel", "3: écart exponentiel", "4: plusieurs écarts constants", "5: plusieurs écarts constants, non symétrique"})
        Me.Combo1.Location = New System.Drawing.Point(144, 64)
        Me.Combo1.Name = "Combo1"
        Me.Combo1.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.Combo1.Size = New System.Drawing.Size(305, 22)
        Me.Combo1.TabIndex = 50
        '
        'Text9
        '
        ...
        Me.Text9.Location = New System.Drawing.Point(160, 96)
        ...
        Me.Text8.Location = New System.Drawing.Point(144, 40)
        ...
        Me.Text7.Location = New System.Drawing.Point(144, 16)
        ...
        Me.Label32.Location = New System.Drawing.Point(280, 96)
        ...
        Me.Label31.Location = New System.Drawing.Point(280, 16)
        ...
        Me.Label10.Text = "longueur de l'élément de bord"
        ...
        Me.Label8.Text = "nombre d'éléments"
        '
        'Label7
        '
        ...
        Me.Label7.Text = "épaisseur des parois"
        '
        'Frame4
        '
        ...
        Me.Label70.Size = New System.Drawing.Size(160, 17)
        Me.Label70.TabIndex = 150
        Me.Label70.Text = "Transport ionique des chlorures"
        '
        'Label63
        '
        ...
        Me.Label63.Size = New System.Drawing.Size(153, 17)
        Me.Label63.TabIndex = 149
        Me.Label63.Text = "Transport hydrique"
        '
        'Label47
        '
        ...
        Me.Label47.Size = New System.Drawing.Size(104, 17)
        Me.Label47.TabIndex = 148
        Me.Label47.Text = "Transport thermique"
        '
        'Button8
        '
...
b:                  frm01.ShowDialog()
    ...
    Private Sub Ecriture(ByRef nFic As Short, ByRef OutFile As String, ByRef Length As Single, ByRef Ne As Short, ByRef Le() As Decimal, ByRef TimeMax As Single, ByRef DeltaT As Single, ByRef taff As Single, ByRef Hsauv As Single, ByRef Wsauv As Single, ByRef CTsauv As Single, ByRef CLsauv As Single, ByRef Tsauv As Single, ByRef hMin As Single, ByRef hEcart As Single, ByRef wMin As Single, ByRef wEcart As Single, ByRef CTmin As Single, ByRef CTecart As Single, ByRef CLmin As Single, ByRef CLecart As Single, ByRef Tecart As Single, ByRef aa As Single, ByRef Hc As Single, ByRef ab As Single, ByRef tc As Single, ByRef H_snap As Single, ByRef Retard As Single, ByRef aOH As Single, ByRef EbG As Single, ByRef toG As Single, ByRef faG As Single, ByRef NEXPO As Short, ByRef capCal As String, ByRef GyCO2 As String, ByRef DyCO2 As String, ByRef Carbsauv As Single, ByRef ImpHydr As Boolean)
        ...
        PrintLine(CInt(nFic), Ne)

        PrintLine(CInt(nFic), ChoixRep)
        Select Case Combo1.Text
            Case "1: écart constant"
                'pas de paramètre à ajouter
            Case "2: écart proportionnel"
                Le(1) = CDec(Text9.Text)
                PrintLine(CInt(nFic), Le(1))
            Case "3: écart exponentiel"
                Le(1) = CDec(Text9.Text)
                PrintLine(CInt(nFic), Le(1))
            Case "4: plusieurs écarts constants"
                PrintLine(CInt(nFic), nChmt)
                For i = 1 To nChmt - 1
                    PrintLine(CInt(nFic), Nbreel(i))
                    PrintLine(CInt(nFic), LenApp(i))
                Next i
            Case "5: plusieurs écarts constants, non symétrique"
                PrintLine(CInt(nFic), nChmt)
                For i = 1 To nChmt - 1
        ...
        PrintLine(CInt(nFic), Nbre1)
        For i = 1 To Nbre1
            PrintLine(CInt(nFic), Creadtherm(0, i))
            PrintLine(CInt(nFic), Creadtherm(1, i))
        Next
        PrintLine(CInt(nFic), Nbre2)
        For i = 1 To Nbre2
            PrintLine(CInt(nFic), Creadhydr(0, i))
            PrintLine(CInt(nFic), Creadhydr(1, i))
        Next
        PrintLine(CInt(nFic), Nbre3)
        For i = 1 To Nbre3
    ...
    Private Sub CtrlParam(ByRef Message As String)
        ...
        Try
            ...
            'Paramètres du programme ... Maillage
            If Text7.Text <= 0 Or Not IsNumeric(Text7.Text) Or Text7.Text = "" Then Message = "L'" & Label7.Text & " est non valide !"
            If Text8.Text <= 0 Or Not IsNumeric(Text8.Text) Or Text8.Text = "" Then Message = "Le " & Label8.Text & " est non valide !"
            If ChoixRep = CShort(0) Then Message = "choix de la répartition du maillage manquant !"
            If Text9.Text < 0 Or Not IsNumeric(Text9.Text) Or Text9.Text = "" Then Message = "La " & Label10.Text & " est non valide !"
    ...
    Private Sub DesChamp()
        Text7.BackColor = System.Drawing.ColorTranslator.FromOle(RGB(128, 128, 128))
        Text8.BackColor = System.Drawing.ColorTranslator.FromOle(RGB(128, 128, 128))
        Combo1.BackColor = System.Drawing.ColorTranslator.FromOle(RGB(128, 128, 128))
        Text9.BackColor = System.Drawing.ColorTranslator.FromOle(RGB(128, 128, 128))
    ...
    Private Sub ActChamp()
        Text7.BackColor = System.Drawing.ColorTranslator.FromOle(RGB(255, 255, 255))
        Text8.BackColor = System.Drawing.ColorTranslator.FromOle(RGB(255, 255, 255))
        Combo1.BackColor = System.Drawing.ColorTranslator.FromOle(RGB(255, 255, 255))
        Text9.BackColor = System.Drawing.ColorTranslator.FromOle(RGB(255, 255, 255))
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        ''''''''''''''''''''''''''''''''''''''''''''
        Filtre = "Text files (CIT_*.txt)|CIT_*.txt"
        Index = 1
        Directoire = True
        Titre = "Conditions initiales thermiques"
        OpenDialog(OutFile, Canc, Filtre, Index, Directoire, Titre)
        If Canc = True Then Exit Sub
        '''''''''''''''''''''''''''''''''''''''''''''
        ...
        FileOpen(nFic, OutFile, OpenMode.Input, OpenAccess.Read, OpenShare.Shared)
        FileOnly(OutFile)
        Label48.Text = OutFile

        Input(nFic, Nbre1)
        If Nbre1 < 2 Then
            MsgBox("Format de fichier invalide", MsgBoxStyle.Information, "Avertissement")
            GoTo b
        End If
        ReDim Creadtherm(1, Nbre1)
...
b:
    ...
    Private Sub Button7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        ''''''''''''''''''''''''''''''''''''''''''''
        Filtre = "Text files (CIH_*.txt)|CIH_*.txt"
        Index = 1
        Directoire = True
        Titre = "Conditions initiales hydriques"
        OpenDialog(OutFile, Canc, Filtre, Index, Directoire, Titre)
        If Canc = True Then Exit Sub
        '''''''''''''''''''''''''''''''''''''''''''''
...
b:
    ...
    Private Sub Button8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button8.Click
        ...
        ''''''''''''''''''''''''''''''''''''''''''''
        Filtre = "Text files (CII_*.txt)|CII_*.txt"
        Index = 1
        Directoire = True
        Titre = "Conditions initiales ioniques"
        OpenDialog(OutFile, Canc, Filtre, Index, Directoire, Titre)
        If Canc = True Then Exit Sub
        '''''''''''''''''''''''''''''''''''''''''''''
